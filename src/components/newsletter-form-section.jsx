...
const NewsletterFormSection = ({ className = "" }) => {
  return (
    <section
      className={`self-stretch bg-aliceblue overflow-hidden flex flex-row items-start justify-center pt-[52px] px-0 pb-[42px] box-border relative max-w-full text-center text-lg text-cornflowerblue-300 font-components-button-large mq750:pt-[34px] mq750:pb-[27px] mq750:box-border ${className}`}
    >
      <img
...
NewsletterFormSection.propTypes = {
