...
const NewsletterFormSection1 = ({ className = "" }) => {
  return (
    <section
      className={`self-stretch bg-aliceblue overflow-hidden flex flex-row items-start justify-center pt-[52px] px-0 pb-[42px] box-border relative max-w-full shrink-0 text-center text-lg text-cornflowerblue-300 font-components-button-large mq750:pt-[34px] mq750:pb-[27px] mq750:box-border ${className}`}
    >
      <img
      ...
      <div className="w-[549px] flex flex-col items-center justify-start p-5 box-border gap-[30px] max-w-full z-[1]">
        <div className="self-stretch flex flex-col items-center justify-start gap-[7px]">
          ...
          <h2 className="m-0 self-stretch relative text-11xl font-bold font-[inherit] text-darkslategray-100 mq1050:text-5xl mq450:text-lg">
            Get weekly updates
          </h2>
        </div>
              ...
              <div className="self-stretch rounded border-other-outlined-border border-[1px] border-solid box-border flex flex-col items-start justify-start py-0 px-[11px] max-w-full">
                <div className="self-stretch overflow-hidden flex flex-row flex-wrap items-center justify-start py-4 px-0 box-border gap-2 max-w-full">
                  <input
                    ...
                    type="text"
                  />
                  <div className="h-7 w-7 relative hidden z-[3]">
                  ...
                  <div className="hidden flex-row items-start justify-start gap-2 z-[1]">
...
NewsletterFormSection1.propTypes = {
  className: PropTypes.string,
};

export default NewsletterFormSection1;
